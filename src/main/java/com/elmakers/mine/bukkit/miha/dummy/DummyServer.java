...
public class DummyServer implements Server {
    ...
    @NotNull
    @Override
    public ItemStack craftItem(@NotNull ItemStack[] itemStacks, @NotNull World world) {
        return null;
    }

    @NotNull
    @Override
    public ItemCraftResult craftItemResult(@NotNull ItemStack[] itemStacks, @NotNull World world, @NotNull Player player) {
        return null;
    }

    @NotNull
    @Override
    public ItemCraftResult craftItemResult(@NotNull ItemStack[] itemStacks, @NotNull World world) {
        return null;
    }
    ...
    @NotNull
    @Override
    public PlayerProfile createPlayerProfile(@Nullable UUID uuid, @Nullable String s) {
        return null;
    }

    @NotNull
    @Override
    public PlayerProfile createPlayerProfile(@NotNull UUID uuid) {
        return null;
    }

    @NotNull
    @Override
    public PlayerProfile createPlayerProfile(@NotNull String s) {
        return null;
    }
    ...
    @NotNull
    @Override
    public Criteria getScoreboardCriteria(@NotNull String s) {
        return null;
    }
    ...
    @Nullable
    @Override
    public <T extends Keyed> Registry<T> getRegistry(@NotNull Class<T> aClass) {
        return (Registry<T>) registries.computeIfAbsent(aClass, key -> DummyRegistry.createRegistry(aClass));
    }
